...
window.SWAHG_LESSONS = {
  ...
  lessons: {
    ...
    "prepare-the-kickoff-meeting": {
      ...
      stage: "working",
      status: "live",
      url: "lesson-prepare-the-kickoff-meeting/",
      closes_va_gaps: [],
      ladders_to_roles: ["va","smm","content","admin","account-manager"],
      prerequisites: [],
      next_lessons: ["what-is-the-tactical-triangle","diagnose-the-current-situation"],
      why_this_lesson: "Walk in as a strategist: a content audit plus tactical-triangle questions, not a blank page.",
      estimated_minutes: 14,
      tier: 1,
      format: "module"
    },
    "what-is-the-tactical-triangle": {
      title: "What Is the Tactical Triangle",
      stage: "working",
      status: "live",
      url: "lesson-what-is-the-tactical-triangle/",
      closes_va_gaps: [],
      ladders_to_roles: ["va","smm","content","account-manager"],
      prerequisites: ["prepare-the-kickoff-meeting"],
      next_lessons: ["diagnose-the-current-situation"],
      why_this_lesson: "Traffic, conversion, cost. Three questions that explain how a business runs.",
      estimated_minutes: 5,
      tier: 1,
      format: "lesson"
    },
    "diagnose-the-current-situation": {
      title: "Diagnose the Current Situation",
      stage: "working",
      status: "live",
      url: "lesson-diagnose-the-current-situation/",
      closes_va_gaps: [],
      ladders_to_roles: ["va","smm","content","account-manager"],
      prerequisites: ["prepare-the-kickoff-meeting"],
      next_lessons: ["how-do-i-diagnose-a-clients-current-situation-through-seo-and-an","onboarding-first-30-days"],
      why_this_lesson: "Check SEO, analytics, newsletter, and social before creating; treat zero as a clean slate.",
      estimated_minutes: 14,
      tier: 1,
      format: "module"
    },
    "how-do-i-diagnose-a-clients-current-situation-through-seo-and-an": {
      title: "How to Diagnose Through SEO and Analytics",
      stage: "working",
      status: "live",
      url: "lesson-how-do-i-diagnose-a-clients-current-situation-through-seo-and-an/",
      closes_va_gaps: [],
      ladders_to_roles: ["va","smm","content"],
      prerequisites: ["diagnose-the-current-situation"],
      next_lessons: ["why-is-starting-from-zero-exciting-instead-of-scary"],
      why_this_lesson: "A beginner-friendly read of the few numbers that matter first.",
      estimated_minutes: 7,
      tier: 1,
      format: "lesson"
    },
    "why-is-starting-from-zero-exciting-instead-of-scary": {
      title: "Why Starting From Zero Is Exciting",
      stage: "working",
      status: "live",
      url: "lesson-why-is-starting-from-zero-exciting-instead-of-scary/",
      closes_va_gaps: [],
      ladders_to_roles: ["va","smm","content"],
      prerequisites: ["diagnose-the-current-situation"],
      next_lessons: ["smm-core-strategies"],
      why_this_lesson: "A blank slate means nothing to undo; build it right from the ground up.",
      estimated_minutes: 5,
      tier: 1,
      format: "lesson"
    },
    ...
    "ai-competitor-analysis": {
      ...
      stage: "working",
      status: "live",
      url: "lesson-ai-competitor-analysis/",
      closes_va_gaps: [],
      ladders_to_roles: ["va","smm","content","account-manager"],
      prerequisites: [],
      next_lessons: ["how-do-i-use-chatgpt-to-analyze-top-competitor-articles","find-the-unique-selling-point"],
      why_this_lesson: "Let AI read the market's best content and explain why it works; you turn it into a content strategy.",
      estimated_minutes: 15,
      tier: 1,
      format: "module"
    },
    "how-do-i-use-chatgpt-to-analyze-top-competitor-articles": {
      title: "How to Use ChatGPT to Analyze Competitor Articles",
      stage: "working",
      status: "live",
      url: "lesson-how-do-i-use-chatgpt-to-analyze-top-competitor-articles/",
      closes_va_gaps: [],
      ladders_to_roles: ["va","smm","content"],
      prerequisites: ["ai-competitor-analysis"],
      next_lessons: ["find-the-unique-selling-point"],
      why_this_lesson: "The three-prompt flow: gather, ask why it works, ask for gaps and pillars.",
      estimated_minutes: 6,
      tier: 1,
      format: "lesson"
    },
    "find-the-unique-selling-point": {
      title: "Find the Unique Selling Point",
      stage: "working",
      status: "live",
      url: "lesson-find-the-unique-selling-point/",
      closes_va_gaps: [],
      ladders_to_roles: ["va","smm","content","account-manager"],
      prerequisites: ["ai-competitor-analysis"],
      next_lessons: ["what-is-a-unique-selling-point-and-why-does-it-matter"],
      why_this_lesson: "The one thing competitors do not have. It centers your content and tests whether the business can win.",
      estimated_minutes: 14,
      tier: 1,
      format: "module"
    },
    "what-is-a-unique-selling-point-and-why-does-it-matter": {
      title: "What Is a Unique Selling Point and Why Does It Matter",
      stage: "working",
      status: "live",
      url: "lesson-what-is-a-unique-selling-point-and-why-does-it-matter/",
      closes_va_gaps: [],
      ladders_to_roles: ["va","smm","content"],
      prerequisites: ["find-the-unique-selling-point"],
      next_lessons: ["how-do-i-judge-whether-a-clients-business-model-is-strong"],
      why_this_lesson: "The plain definition and the 'unlike competitors, we ____' test.",
      estimated_minutes: 5,
      tier: 1,
      format: "lesson"
    },
    "how-do-i-judge-whether-a-clients-business-model-is-strong": {
      title: "How to Judge Whether a Business Model Is Strong",
      stage: "working",
      status: "live",
      url: "lesson-how-do-i-judge-whether-a-clients-business-model-is-strong/",
      closes_va_gaps: [],
      ladders_to_roles: ["va","smm","content","account-manager"],
      prerequisites: ["find-the-unique-selling-point"],
      next_lessons: ["why-clients-come-and-go"],
      why_this_lesson: "A clear USP is the simplest test of a model that can win.",
      estimated_minutes: 6,
      tier: 1,
      format: "lesson"
    },
