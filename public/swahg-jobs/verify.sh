...
ROLE_LABELS = ["Digital Marketing Specialist", "Digital Marketing Manager", "Social Media Specialist", "Social Media Manager", "Content Specialist", "Community Manager", "SEO", "Virtual Assistant", "Executive Assistant"]
SHEET_KEYS = ["id", "date_added", "status", "title", "company", "posted", "role_lala_category", "seniority", "job_location", "remote_type", "timezone_required", "ph_eligible", "contract_type", "salary_range", "pay_type", "tools_required", "skill_match_count", "hard_knockouts", "fit_score", "newbie_friendly", "why_it_fits", "why_it_might_not", "apply_url", "ats_platform", "industry", "about_the_company", "position_overview", "key_responsibilities", "qualifications", "what_we_offer", "location_work_setup", "hours_schedule", "application_process", "rodge_notes", "days_old"]
...
expected_tabs = ["All Jobs", "🏆 Top Picks", "🌱 Newbie Friendly", "📱 Social Media", "✍️ Content", "🔍 SEO + Digital Marketing", "📋 VA + EA", "📊 Stats"]
...
assert values and values[0][:35] == SHEET_KEYS, "All Jobs header mismatch"
...
for detail in details:
    ...
    for index, key in enumerate(SHEET_KEYS[:33]):
