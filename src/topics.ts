...
export const TOPICS: Topic[] = [
  ...
  { slug: 'bff-stories', name: 'BFF Stories', description: 'Real words from Bonafide Filipino Freelancers about community, work, courage, and change.', group: 'professional' },
