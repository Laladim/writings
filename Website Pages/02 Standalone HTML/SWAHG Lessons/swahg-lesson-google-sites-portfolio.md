<!-- WBL_OBSIDIAN_SYNC
kind: html-text-map
sourcePath: public/swahg-lesson-google-sites-portfolio/index.html
url: /swahg-lesson-google-sites-portfolio/
WBL_OBSIDIAN_SYNC_END -->
# Google Sites Portfolio | Zero Work Experience · SWAHG Open University · Skill Practice

Source: `public/swahg-lesson-google-sites-portfolio/index.html`
Live path: `/swahg-lesson-google-sites-portfolio/`
...
<!-- wbl-text:0019 -->
Fresh Starters with no paid client samples yet
...
<!-- wbl-text:0023 -->
One published Google Sites portfolio
...
<!-- wbl-text:0037 -->
Navigation structure when you cannot organize by industry experience
...
<!-- wbl-text:0062 -->
Google Sites is a practical first platform because it allows you to start from a blank site or template, add pages, text, and images, then publish a shareable web address. Google’s own help documentation says you can create a site from Blank or the Template gallery, add pages through the Pages panel, add text boxes, and publish changes from the editor. (

<!-- wbl-text:0063 -->
Google Help

<!-- wbl-text:0064 -->
) Google also describes Sites as a drag-and-drop website creator with an automatic grid layout that scales across devices, which matters for a beginner portfolio that needs to be easy to view on phones and laptops. (
...
<!-- wbl-text:0074 -->
A process document from meal planning

<!-- wbl-text:0075 -->
A data tracker from personal budgeting

<!-- wbl-text:0076 -->
A presentation from learning notes
...
<!-- wbl-text:0084 -->
) The ethical boundary is simple: label the work correctly. Call it a self-directed sample, practice project, learning project, volunteer project, school project, or personal system. Do not call it client work if it was not client work.
...
<!-- wbl-text:0086 -->
The University of Waterloo’s teaching guidance on ePortfolios explains that an ePortfolio can be more than a collection of finished products. It can document learning, make learning visible, and combine artifacts with reflection on what those artifacts represent. (

<!-- wbl-text:0087 -->
University of Waterloo

<!-- wbl-text:0088 -->
) That is exactly the right frame for a zero-experience builder. You are not trying to look like someone with five years of client work. You are making your learning and practice visible.
...
<!-- wbl-text:0109 -->
Google’s Sites help documentation says you can preview your site, publish it, enter a web address, visit the address to check it, and choose whether the published site is Restricted or Public. (

<!-- wbl-text:0110 -->
Google Help

<!-- wbl-text:0111 -->
) Google also gives customization options through themes, including backgrounds, text colors, default text styles, brand images, favicons, buttons, dividers, links, image carousels, site width, and menu text or background color. (
...
<!-- wbl-text:0121 -->
Choose your structure first, then choose the simplest template that can hold it. In fact, for this portfolio, the best choice is often a blank Google Site. Google’s own setup instructions allow either Blank or Template gallery, so you are not forced to start from a template. (
...
<!-- wbl-text:0172 -->
This section matters because career readiness is not just job history. NACE describes career readiness through competencies such as career and self-development, communication, critical thinking, professionalism, teamwork, and technology. (

<!-- wbl-text:0173 -->
Default

<!-- wbl-text:0174 -->
) A Learning Journey section gives you a place to show career and self-development honestly.
...
<!-- wbl-text:0208 -->
Google Docs is a suitable tool for this type of sample because it supports online document creation, collaboration, mobile access, comments, sharing settings, and version history. (
...
<!-- wbl-text:0227 -->
Indeed’s portfolio guidance includes contact information as a core portfolio element and recommends keeping portfolio links and contact details easy to find and up to date. (
...
<!-- wbl-text:0242 -->
The skills you are practicing

<!-- wbl-text:0243 -->
The tools you are using

<!-- wbl-text:0244 -->
The kind of work you are preparing for

<!-- wbl-text:0245 -->
The proof you have already created
...
<!-- wbl-text:0266 -->
Google’s Workspace guidance says effective Gemini prompts should use natural language, be clear and concise, provide context, use specific and relevant keywords, and break complex tasks into separate prompts. (

<!-- wbl-text:0267 -->
Google Help

<!-- wbl-text:0268 -->
) Google’s business prompting guidance also frames prompting as a conversation and identifies prompt components such as persona, task, context, and format. (
...
<!-- wbl-text:0278 -->
Also review outputs carefully. Google’s Gemini Apps Privacy Hub states that large language model experiences, including Gemini Apps, can hallucinate and present inaccurate information as factual. (

<!-- wbl-text:0279 -->
Google Help

<!-- wbl-text:0280 -->
) Google also describes Gemini’s Double-check feature as a way to use Google Search to help verify statements in a response. (
...
<!-- wbl-text:0323 -->
Google Sites lets you add and organize pages through the Pages panel, and it also allows anchor links to specific headers or subheaders on a published site. (

<!-- wbl-text:0324 -->
Google Help

<!-- wbl-text:0325 -->
) For your first version, use one page with clear section headers. That gives you the benefit of structure without making you manage many pages.
...
<!-- wbl-text:0332 -->
Create the three work samples.

<!-- wbl-text:0333 -->
Write short descriptions for each sample.

<!-- wbl-text:0334 -->
Set file sharing to Viewer access.

<!-- wbl-text:0335 -->
Build the Google Site sections.

<!-- wbl-text:0336 -->
Write the homepage hero.
...
<!-- wbl-text:0366 -->
This is not about food. It is about process thinking. Google Docs is appropriate here because it supports document creation, editing, comments, sharing settings, and collaboration features. (
...
<!-- wbl-text:0381 -->
Google Sheets is designed for online collaborative spreadsheets and helps users manage, visualize, and analyze data. (

<!-- wbl-text:0382 -->
Google Workspace

<!-- wbl-text:0383 -->
) Your tracker does not need advanced formulas. It needs clean organization and accurate labels.
...
<!-- wbl-text:0395 -->
Google Slides supports presentation creation, templates, collaboration, live editing, comments, sharing controls, and offline access for some workflows. (

<!-- wbl-text:0396 -->
Google Workspace

<!-- wbl-text:0397 -->
) For a Fresh Starter, the goal is not visual perfection. The goal is clear organization.
...
<!-- wbl-text:0409 -->
Set each file to Viewer access. Google Drive allows file owners to choose access and roles such as Viewer, Commenter, or Editor. (

<!-- wbl-text:0410 -->
Google Help

<!-- wbl-text:0411 -->
) For portfolio samples, Viewer access is usually enough.
...
<!-- wbl-text:0426 -->
Google Sites provides theme controls for colors, default text styles, buttons, dividers, links, image carousels, site width, and menu appearance. (

<!-- wbl-text:0427 -->
Google Help

<!-- wbl-text:0428 -->
) Use those basics. Do not fight the platform.

<!-- wbl-text:0429 -->
Hours 41 to 44: Preview and fix

<!-- wbl-text:0430 -->
Preview the site. Check desktop and mobile layout. Google’s publishing instructions tell users to preview the site and choose a layout option before publishing. (
...
<!-- wbl-text:0441 -->
Publish the site. Google Sites lets you enter a web address, publish, and then visit the address to confirm it works. (
...
<!-- wbl-text:0600 -->
Google Sheets is suitable because it is designed for collaborative spreadsheets that help users manage, visualize, and analyze data. (

<!-- wbl-text:0601 -->
Google Workspace

<!-- wbl-text:0602 -->
) A beginner version can still show organized thinking.
...
<!-- wbl-text:0639 -->
Google Slides supports templates, presentation creation, live editing, comments, sharing controls, and collaboration. (

<!-- wbl-text:0640 -->
Google Workspace

<!-- wbl-text:0641 -->
) Your sample can show that you understand how to organize a message for someone else.
...
<!-- wbl-text:0669 -->
This is also why reflection matters. Waterloo’s ePortfolio guidance emphasizes that strong ePortfolios combine artifacts with reflection and can make invisible parts of learning visible. (

<!-- wbl-text:0670 -->
University of Waterloo

<!-- wbl-text:0671 -->
) For a beginner, the reflection may be the most important part because it shows how you think about improvement.
...
<!-- wbl-text:0698 -->
Google’s Gmail help explains that account creation allows choices such as Personal use, Child, or Work or business. (

<!-- wbl-text:0699 -->
Google Help

<!-- wbl-text:0700 -->
) Gmail also provides “Send mail as” settings for adding another email address and setting a default send-from or reply-to address. (
...
<!-- wbl-text:0722 -->
Google Sites lets you choose sharing options for the published site, including Restricted or Public, and Restricted sites can be shared with specific people. (
...
<!-- wbl-text:0756 -->
Google Sites gives you basic theme controls, including backgrounds, colors, text styles, brand images, buttons, dividers, links, image carousels, site width, and menu appearance. (

<!-- wbl-text:0757 -->
Google Help

<!-- wbl-text:0758 -->
) Use those controls lightly.
...
<!-- wbl-text:0907 -->
The larger job market is also moving toward more attention on skills. LinkedIn’s Future of Recruiting 2025 report describes skills-based hiring as increasingly important as employers look for specific skills rather than only degrees or job history. (

<!-- wbl-text:0908 -->
LinkedIn Business Solutions

<!-- wbl-text:0909 -->
) The World Economic Forum’s Future of Jobs Report 2025 is based on input from over 1,000 employers representing more than 14 million workers, and it focuses heavily on jobs and skills transformation. (

<!-- wbl-text:0910 -->
World Economic Forum

<!-- wbl-text:0911 -->
) That does not mean a beginner portfolio guarantees hiring. It means visible skill evidence is a rational thing to build.
...
<!-- wbl-text:1005 -->
Google Sites publishing controls allow you to preview the site, publish it, and choose who can see the published site. (
...
<!-- wbl-text:1024 -->
Only include a resume if it supports the portfolio. A simple resume can help connect your education, volunteer work, skills, and portfolio link. Indeed’s portfolio guidance recommends that resumes and portfolio samples stay consistent so employers can connect the work to your background. (
...
<!-- wbl-text:1029 -->
You can, but you do not need to. Google Sites lets you start from Blank or choose from the Template gallery. (

<!-- wbl-text:1030 -->
Google Help

<!-- wbl-text:1031 -->
) For a zero-experience portfolio, structure matters more than the template. A blank site with the five sections in this guide is enough.

<!-- wbl-text:1032 -->
Can I use Gemini to write all the content?

<!-- wbl-text:1033 -->
Use Gemini to assist, not replace. Give it your real notes, ask it to organize and clarify, then edit the output. Remove unsupported claims. Google’s prompt guidance recommends clear, contextual prompts, and Google also warns that Gemini Apps can produce inaccurate factual statements. (
...
<!-- wbl-text:1038 -->
Google Sites has an option to request that public search engines not display a public site, but Google notes that this request does not guarantee the site will not appear in public search engines. (

<!-- wbl-text:1039 -->
Google Help

<!-- wbl-text:1040 -->
) For applications, you usually need the site to be viewable by the person receiving the link. Use Restricted for private review and Public when you are ready to share more broadly.

<!-- wbl-text:1041 -->
What if my Google Site looks too plain?

<!-- wbl-text:1042 -->
Plain is acceptable. Confusing is not. A beginner portfolio should be readable, organized, and honest. Use Google Sites’ built-in theme controls for colors, text styles, buttons, dividers, links, and layout width, but keep the focus on the samples. (
...
<!-- wbl-text:1127 -->
Skill Practice · Google Sites Portfolio | Zero Work Experience · Complete guide · May 18, 2026 · Writings by Lala
